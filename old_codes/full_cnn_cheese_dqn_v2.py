...
save_path = f"./saved_models/full_cnn_cheese_dqn10_v2/{date_time}"
load_path = f"./saved_models/full_cnn_cheese_dqn10_v2/20231115155738"
    ...
    def to_gray(frame1, frame2=None):
        ...
        if frame2 is not None:
            new_frame = torch.sign(
                torch.sign(gray_transform(frame1))[:, 20:, 3:-3] - 0.5 * torch.where(frame2 > 0, frame2, torch.tensor(0.)))
        else:
